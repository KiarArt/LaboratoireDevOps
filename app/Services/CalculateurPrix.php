...
class CalculateurPrix
{
    ...
    public function calculerAvecTaxe(float $prixHT, float $tauxTaxe): float
    {
        if ($tauxTaxe < 0 || $prixHT < 0) {
            throw new \InvalidArgumentException("Le taux de taxe et le prix HT ne peuvent pas être négatifs.");
        }
    ...
    public function appliquerRemise(float $prix, float $remisePourcentage): float
    {
        if ($remisePourcentage < 0 || $prix < 0) {
            throw new \InvalidArgumentException("La remise ne peut pas être négative et le prix ne peut pas être négatif.");
        }
    ...
    public function respecteSeuilMinimum(float $prix, float $seuilMinimum): bool
    {
        if ($seuilMinimum < 0 || $prix < 0) {
            throw new \InvalidArgumentException("Le seuil minimum ne peut pas être négatif ou Le prix ne peut pas être négatif.");
        }
